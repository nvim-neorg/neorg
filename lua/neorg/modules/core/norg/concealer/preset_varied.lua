    ...
    quote = {
        ...
        level_2 = {
            ...
            render = function(self)
                return {
                    { self.icon, module.config.private.icon_preset_varied.quote.level_1.highlight },
        ...
        level_3 = {
            ...
            render = function(self)
                return {
                    { self.icon, module.config.private.icon_preset_varied.quote.level_1.highlight },
                    { self.icon, module.config.private.icon_preset_varied.quote.level_2.highlight },
                    { self.icon, self.highlight },
                }
            end,
        },
        ...
        level_4 = {
            ...
            render = function(self)
                return {
                    { self.icon, module.config.private.icon_preset_varied.quote.level_1.highlight },
                    { self.icon, module.config.private.icon_preset_varied.quote.level_2.highlight },
                    { self.icon, module.config.private.icon_preset_varied.quote.level_3.highlight },
                    { self.icon, self.highlight },
                }
            end,
        },
        ...
        level_5 = {
            ...
            render = function(self)
                return {
                    ...
                    { self.icon, module.config.private.icon_preset_varied.quote.level_2.highlight },
                    { self.icon, module.config.private.icon_preset_varied.quote.level_3.highlight },
                    { self.icon, module.config.private.icon_preset_varied.quote.level_4.highlight },
                    { self.icon, self.highlight },
                }
            end,
        },
        ...
        level_6 = {
            ...
            render = function(self)
                return {
                    ...
                    { self.icon, module.config.private.icon_preset_varied.quote.level_3.highlight },
                    { self.icon, module.config.private.icon_preset_varied.quote.level_4.highlight },
                    { self.icon, module.config.private.icon_preset_varied.quote.level_5.highlight },
                    { self.icon, self.highlight },
                }
            end,
        },
