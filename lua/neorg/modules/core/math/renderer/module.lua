--[[
    ...
    summary: An experimental module for rendering math inline
    ---

This is an experimental module that requires nvim 0.10+. It renders math snippets as images making
use of the image.nvim plugin. By default, images are only rendered after running the command:
`:Neorg render-math`. Rendering can be disabled with `:Neorg render-math disable`

Requires:
- [image.nvim](https://github.com/3rd/image.nvim)

A highlight group that controls the foreground color of the rendered math: `@norg.rendered.math`,
configurable in `core.highlights`. It links to `:h hi-Normal` by default.
--]]
local nio
