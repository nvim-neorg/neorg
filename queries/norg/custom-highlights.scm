...
; 
; ; Headings
; (heading1 title: (paragraph_segment) @NeorgHeading1Title)
; (heading2 title: (paragraph_segment) @NeorgHeading2Title)
; (heading3 title: (paragraph_segment) @NeorgHeading3Title)
; (heading4 title: (paragraph_segment) @NeorgHeading4Title)
; (heading5 title: (paragraph_segment) @NeorgHeading5Title)
; (heading6 title: (paragraph_segment) @NeorgHeading6Title)
; 
; (heading1_prefix) @NeorgHeading1Prefix 
; (heading2_prefix) @NeorgHeading2Prefix 
; (heading3_prefix) @NeorgHeading3Prefix 
; (heading4_prefix) @NeorgHeading4Prefix 
; (heading5_prefix) @NeorgHeading5Prefix 
; (heading6_prefix) @NeorgHeading6Prefix 
; 
; ; Display errors
; (ERROR) @NeorgError
; 
; ; Markers
; (marker (paragraph_segment) @NeorgMarkerTitle)
; (marker_prefix) @NeorgMarkerPrefix 
; 
; ; Definitions
...
; 
; ; Footnotes
; (single_footnote title: (paragraph_segment) @NeorgFootnoteTitle content: [(_) "_paragraph_break"]* @NeorgFootnoteContent)
; (single_footnote_prefix) @NeorgFootnote
; 
; (multi_footnote title: (paragraph_segment) @NeorgFootnoteTitle content: [(_) "_paragraph_break"]* @NeorgFootnoteContent end: (multi_footnote_suffix) @NeorgFootnoteEnd)
; (multi_footnote_prefix) @NeorgFootnote 
; 
...
; 
; ; Unordered lists
; (unordered_list1 content: (paragraph) @NeorgUnorderedList1Content)
; (unordered_list2 content: (paragraph) @NeorgUnorderedList2Content)
; (unordered_list3 content: (paragraph) @NeorgUnorderedList3Content)
; (unordered_list4 content: (paragraph) @NeorgUnorderedList4Content)
; (unordered_list5 content: (paragraph) @NeorgUnorderedList5Content)
; (unordered_list6 content: (paragraph) @NeorgUnorderedList6Content)
; 
; (unordered_list1_prefix) @NeorgUnorderedList1 
; (unordered_list2_prefix) @NeorgUnorderedList2 
; (unordered_list3_prefix) @NeorgUnorderedList3 
; (unordered_list4_prefix) @NeorgUnorderedList4 
; (unordered_list5_prefix) @NeorgUnorderedList5 
; (unordered_list6_prefix) @NeorgUnorderedList6 
; 
; ; Ordered lists
; (ordered_list1 content: (paragraph) @NeorgOrderedList1Content)
; (ordered_list2 content: (paragraph) @NeorgOrderedList2Content)
; (ordered_list3 content: (paragraph) @NeorgOrderedList3Content)
; (ordered_list4 content: (paragraph) @NeorgOrderedList4Content)
; (ordered_list5 content: (paragraph) @NeorgOrderedList5Content)
; (ordered_list6 content: (paragraph) @NeorgOrderedList6Content)
; 
; (ordered_list1_prefix) @NeorgOrderedList1
; (ordered_list2_prefix) @NeorgOrderedList2
; (ordered_list3_prefix) @NeorgOrderedList3
; (ordered_list4_prefix) @NeorgOrderedList4
; (ordered_list5_prefix) @NeorgOrderedList5
; (ordered_list6_prefix) @NeorgOrderedList6
; 
; ; Unordered links
; (unordered_link1 location: (link) @NeorgUnorderedLink1Location)
; (unordered_link2 location: (link) @NeorgUnorderedLink2Location)
; (unordered_link3 location: (link) @NeorgUnorderedLink3Location)
; (unordered_link4 location: (link) @NeorgUnorderedLink4Location)
; (unordered_link5 location: (link) @NeorgUnorderedLink5Location)
; (unordered_link6 location: (link) @NeorgUnorderedLink6Location)
; 
; (unordered_link1_prefix) @NeorgUnorderedLink1
; (unordered_link2_prefix) @NeorgUnorderedLink2
; (unordered_link3_prefix) @NeorgUnorderedLink3
; (unordered_link4_prefix) @NeorgUnorderedLink4
; (unordered_link5_prefix) @NeorgUnorderedLink5
; (unordered_link6_prefix) @NeorgUnorderedLink6
; 
; ; Ordered links
; (ordered_link1 location: (link) @NeorgOrderedLink1Location)
; (ordered_link2 location: (link) @NeorgOrderedLink2Location)
; (ordered_link3 location: (link) @NeorgOrderedLink3Location)
; (ordered_link4 location: (link) @NeorgOrderedLink4Location)
; (ordered_link5 location: (link) @NeorgOrderedLink5Location)
; (ordered_link6 location: (link) @NeorgOrderedLink6Location)
; 
; (ordered_link1_prefix) @NeorgOrderedLink1
; (ordered_link2_prefix) @NeorgOrderedLink2
; (ordered_link3_prefix) @NeorgOrderedLink3
; (ordered_link4_prefix) @NeorgOrderedLink4
; (ordered_link5_prefix) @NeorgOrderedLink5
; (ordered_link6_prefix) @NeorgOrderedLink6
; 
; ; Quotes
; (quote1 content: (paragraph_segment) @NeorgQuote1Content)
; (quote2 content: (paragraph_segment) @NeorgQuote2Content)
; (quote3 content: (paragraph_segment) @NeorgQuote3Content)
; (quote4 content: (paragraph_segment) @NeorgQuote4Content)
; (quote5 content: (paragraph_segment) @NeorgQuote5Content)
; (quote6 content: (paragraph_segment) @NeorgQuote6Content)
; 
; (quote1_prefix) @NeorgQuote1
; (quote2_prefix) @NeorgQuote2
; (quote3_prefix) @NeorgQuote3
; (quote4_prefix) @NeorgQuote4
; (quote5_prefix) @NeorgQuote5
; (quote6_prefix) @NeorgQuote6
; 
; ; Insertion
