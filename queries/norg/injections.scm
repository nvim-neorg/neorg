...
(ranged_verbatim_tag (tag_name) @_tagname (tag_parameters parameter: (tag_param) @language) (ranged_verbatim_tag_content) @content (#eq? @_tagname "code") (#not-eq? @language "norg"))
